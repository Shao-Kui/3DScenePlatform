...
class cgDiff:
    def __init__(self, results):
        ...
        self.graphDistance = 1 - np.clip(self.normalizedGraphKernel, None, 1.0)
...
def cgs(domID, subIDs, seriesName):
    ...
    print(resultOrigin['similarity'][1][1, [1,4,5,12]] / np.max(resultOrigin['similarity'][1]))
    print(resultOrigin['similarity'][1][4, [1,4,5,12]] / np.max(resultOrigin['similarity'][1]))
    print(resultOrigin['similarity'][1][5, [1,4,5,12]] / np.max(resultOrigin['similarity'][1]))
    print(resultOrigin['similarity'][1][12, [1,4,5,12]] / np.max(resultOrigin['similarity'][1]))
