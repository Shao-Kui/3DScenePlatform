        ...
        !function (t, e) {
            ...
            return function (t) {
                            ...
                            return l(t, [
                                {
                                    key: 'encode',
                                    value: function (t) {
                                        return t.type !== p.EVENT && t.type !== p.ACK || !d.hasBinary(t) ? [this.encodeAsString(t)] : (t.type = t.type === p.EVENT ? p.BINARY_EVENT : p.BINARY_ACK, this.encodeAsBinary(t));
                                    }
                                },
                                {
                                    key: 'encodeAsString',
                                    value: function (t) {
                                        var e = '' + t.type;
                                        return t.type !== p.BINARY_EVENT && t.type !== p.BINARY_ACK || (e += t.attachments + '-'), t.nsp && '/' !== t.nsp && (e += t.nsp + ','), null != t.id && (e += t.id), null != t.data && (e += JSON.stringify(t.data)), e;
                                    }
                                },
                                {
                                    key: 'encodeAsBinary',
                            ...
                            return l(n, [
                                {
                                    ...
                                    value: function (t) {
                                        var e;
                                        if ('string' == typeof t)
                                            (e = this.decodeString(t)).type === p.BINARY_EVENT || e.type === p.BINARY_ACK ? (this.reconstructor = new m(e), 0 === e.attachments && o(a(n.prototype), 'emit', this).call(this, 'decoded', e)) : o(a(n.prototype), 'emit', this).call(this, 'decoded', e);
                                        else {
                    ...
                    var u = n(20), f = n(14), l = n(5), p = n(16), h = n(31), y = function (t) {
                            ...
                            function y(t, e) {
                                ...
                                !function (t, e) {
                                    if (!(t instanceof e))
                                        throw new TypeError('Cannot call a class as a function');
                                }(this, y), (n = a.call(this)).nsps = {}, n.subs = [], t && 'object' === r(t) && (e = t, t = void 0), (e = e || {}).path = e.path || '/socket.io', n.opts = e, n.reconnection(!1 !== e.reconnection), n.reconnectionAttempts(e.reconnectionAttempts || 1 / 0), n.reconnectionDelay(e.reconnectionDelay || 1000), n.reconnectionDelayMax(e.reconnectionDelayMax || 5000), n.randomizationFactor(e.randomizationFactor || 0.5), n.backoff = new h({
                                    min: n.reconnectionDelay(),
                                    max: n.reconnectionDelayMax(),
                                    jitter: n.randomizationFactor()
                                }), n.timeout(null == e.timeout ? 20000 : e.timeout), n._readyState = 'closed', n.uri = t;
                                var o = e.parser || l;
                            ...
                            return e = u, (n = [
                                ...
                                },
                                {
                                    ...
                                    value: function () {
                                        ...
                                        return !1 !== this.opts.timestampRequests && (t[this.opts.timestampParam] = h()), this.supportsBinary || t.sid || (t.b64 = 1), t = l.encode(t), this.opts.port && ('https' === e && 443 !== Number(this.opts.port) || 'http' === e && 80 !== Number(this.opts.port)) && (n = ':' + this.opts.port), t.length && (t = '?' + t), e + '://' + (-1 !== this.opts.hostname.indexOf(':') ? '[' + this.opts.hostname + ']' : this.opts.hostname) + n + this.opts.path + t;
                                    }
                                },
                                {
                                    key: 'name',
                                ...
                                },
                                {
                                    ...
                                    value: function (t) {
                                        for (var e, n = arguments.length, r = new Array(n > 1 ? n - 1 : 0), o = 1; o < n; o++)
                                            r[o - 1] = arguments[o];
                                        return (e = s(f(l.prototype), 'emit', this)).call.apply(e, [
                                            this,
                                            t
                                        ].concat(r)), this;
                                    }
                ...
                function (t, e, n) {
                    ...
                    Object.defineProperty(e, '__esModule', { value: !0 }), e.io = e.Socket = e.Manager = e.protocol = void 0;
                    var o = n(19), i = n(7);
                    t.exports = e = c;
                    var s = e.managers = {};
                    function c(t, e) {
                        ...
                        return e.forceNew || e['force new connection'] || !1 === e.multiplex || l ? n = new i.Manager(a, e) : (s[u] || (s[u] = new i.Manager(a, e)), n = s[u]), c.query && !e.query && (e.query = c.queryKey), n.socket(c.path, e);
                    }
                    e.io = c;
                    var a = n(5);
                ...
                function (t, e, n) {
                    ...
                    var l = n(8), p = n(1), h = n(0), y = n(6), d = n(4), v = function (t) {
                            ...
                            function p(t) {
                                ...
                                }, n), e.opts.path = e.opts.path.replace(/\/$/, '') + '/', 'string' == typeof e.opts.query && (e.opts.query = d.decode(e.opts.query)), e.id = null, e.upgrades = null, e.pingInterval = null, e.pingTimeout = null, e.pingTimeoutTimer = null, 'function' == typeof addEventListener && (e.opts.closeOnBeforeunload && addEventListener('beforeunload', function () {
                            ...
                            return e = p, (n = [
                                ...
                                },
                                {
                                    ...
                                    value: function () {
                                        var t, e = this;
                                        if (this.opts.rememberUpgrade && p.priorWebsocketSuccess && -1 !== this.transports.indexOf('websocket'))
                                            t = 'websocket';
                                        else {
                                ...
                                },
                                {
                                    key: 'probe',
                                    value: function (t) {
                                        var e = this, n = this.createTransport(t, { probe: 1 }), r = !1;
                                            ...
                                            r || (n.send([{
                                                ...
                                                if (!r)
                                                    if ('pong' === t.type && 'probe' === t.data) {
                                                        if (e.upgrading = !0, e.emit('upgrading', n), !n)
                                                            return;
                                                        p.priorWebsocketSuccess = 'websocket' === n.name, e.transport.pause(function () {
                                                            r || 'closed' !== e.readyState && (f(), e.setTransport(n), n.send([{ type: 'upgrade' }]), e.emit('upgrade', n), n = null, e.upgrading = !1, e.flush());
                                                        });
                                                    } else {
                                        ...
                                        var f = function () {
                                            n.removeListener('open', o), n.removeListener('error', s), n.removeListener('close', c), e.removeListener('close', a), e.removeListener('upgrading', u);
                                        };
                                        n.once('open', o), n.once('error', s), n.once('close', c), this.once('close', a), this.once('upgrading', u), n.open();
                                    }
                                },
                                {
                                    key: 'onOpen',
                                    value: function () {
                                        if (this.readyState = 'open', p.priorWebsocketSuccess = 'websocket' === this.transport.name, this.emit('open'), this.flush(), 'open' === this.readyState && this.opts.upgrade && this.transport.pause)
                            ...
                            return c(n, [
                                {
                                    ...
                                    value: function () {
                                        ...
                                        try {
                                            ...
                                            'withCredentials' in r && (r.withCredentials = this.opts.withCredentials), this.opts.requestTimeout && (r.timeout = this.opts.requestTimeout), this.hasXDR() ? (r.onload = function () {
                                                t.onLoad();
                                            }, r.onerror = function () {
                                ...
                                },
                                {
                                    ...
                                    value: function (t) {
                                        if (void 0 !== this.xhr && null !== this.xhr) {
                                            if (this.hasXDR() ? this.xhr.onload = this.xhr.onerror = m : this.xhr.onreadystatechange = m, t)
                                                try {
                                                    this.xhr.abort();
                                                } catch (t) {
                                                }
                ...
                function (t, e) {
                    !function (t) {
                        ...
                        e.encode = function (e) {
                            ...
                            var n, r, o, i, s, c = 0.75 * e.length, a = e.length, u = 0;
                            '=' === e[e.length - 1] && (c--, '=' === e[e.length - 2] && c--);
                            var f = new ArrayBuffer(c), l = new Uint8Array(f);
                            for (n = 0; n < a; n += 4)
                                r = t.indexOf(e[n]), o = t.indexOf(e[n + 1]), i = t.indexOf(e[n + 2]), s = t.indexOf(e[n + 3]), l[u++] = r << 2 | o >> 4, l[u++] = (15 & o) << 4 | i >> 2, l[u++] = (3 & i) << 6 | 63 & s;
                            return f;
                        };
                    ...
                    var l, p = n(10), h = n(2), y = /\n/g, d = /\\n/g, v = function (t) {
                            ...
                            function p(t) {
                                ...
                                return function (t, e) {
                                    if (!(t instanceof e))
                                        throw new TypeError('Cannot call a class as a function');
                                }(this, p), (e = a.call(this, t)).query = e.query || {}, l || (l = h.___eio = h.___eio || []), e.index = l.length, l.push(e.onData.bind(u(e))), e.query.j = e.index, e;
                            }
                            return e = p, (n = [
                                {
                                    key: 'doClose',
                                    value: function () {
                                        ...
                                        }, this.script.parentNode.removeChild(this.script), this.script = null), this.form && (this.form.parentNode.removeChild(this.form), this.form = null, this.iframe = null), i(f(p.prototype), 'doClose', this).call(this);
                                    }
                                },
                                {
                                    key: 'doPoll',
