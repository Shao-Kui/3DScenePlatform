...
namespace Unity.VisualScripting.FullSerializer
{
    ...
    public class InputAction_DirectConverter : fsDirectConverter<InputAction>
    {
        ...
        protected override fsResult DoDeserialize(Dictionary<string, fsData> data, ref InputAction model)
        {
            ...
            model = MakeInputActionWithId(actionId, actionName, expectedControlType);
        ...
        /// </summary>
        public static InputAction MakeInputActionWithId(string actionId, string actionName, string expectedControlType)
        {
