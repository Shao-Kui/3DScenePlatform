    ...
    "rooms": [
        {
			...
			"roomShapeBBox": { "max": [7.5, 7.5], "min": [0, 0] },
            ...
            "objList": [
				{
					...
					"bbox": { "min": [1.3, 0.8, -0.12], "max": [2.3, 2.2, 0] },
					"inDatabase": False,
					"format": "Window",
				...
				},
				{
					...
					"translate": [7.5600000000000005, 0.8, 1.125],
					"bbox": { "min": [7.5, 0.8, 0.625], "max": [7.62, 2.2, 1.625] },
					"inDatabase": False,
					"format": "Window",
					"coarseSemantic": "Window"
				},
				{
					...
					"translate": [7.5600000000000005, 0.8, 3.375],
					"bbox": { "min": [7.5, 0.8, 2.875], "max": [7.62, 2.2, 3.875] },
					"inDatabase": False,
					"format": "Window",
					"coarseSemantic": "Window"
				},
				{
					...
					"translate": [3.35, 0, 7.5600000000000005],
					"bbox": { "min": [2.95, 0, 7.5], "max": [3.75, 2.2, 7.62] },
					"inDatabase": False,
					"format": "Door",
					"coarseSemantic": "Door"
				},
...
for i in range(random.randint(4, 8)):
    ...
    with open(os.path.join('./object', file_name), 'r') as f:
        ...
        obj['translate'] = [random.uniform(0, 7), 0, random.uniform(0, 7)]
